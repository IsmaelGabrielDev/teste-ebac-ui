...
describe('Funcionalidade: Produtos', () => {
    ...
    it('Deve selecionar um produto', () => {
        //contains para pegar o elemento pelo texto
        cy.get('.product-block').contains('Aero Daily Fitness Tee').click()
        //first para pegar o primeiro elemento
        cy.get('.product-block').first().click()
        //last para pegar o ultimo elemento
        cy.get('.product-block').last().click()
        //eq para pegar o elemento pela posicao, comecando pelo 0
